...
class Logger
{
    ...
    private $_previousRecordTime = null;
    ...
    {
        $recordTime = microtime(true) - $this->_previousRecordTime;
        ...
        $record = array(
            ...
            'channel' => $this->name,
            'datetime' => \DateTime::createFromFormat('U.u', sprintf('%.6F', microtime(true)))->format('Y-m-d H:i:s') . "][" . sprintf("%f", $recordTime),
            'extra' => array(),
        );
        ...
        $this->_previousRecordTime = microtime(true);
        return true;
    }
